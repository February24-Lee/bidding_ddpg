...
if __name__ == "__main__":
    ...
    # --- auction path
    parser.add_argument('--camp',                   type=str,       default='3358')
    ...
    # --- linear agent
    parser.add_argument('--lin-b0-path',            type=str,       default=f'data/linear_agent/ipinyou-data/{3358}/bid-model/lin-bid_1000_{1/32}_clk_{118514}.pickle')

    # --- test 
    parser.add_argument('--agent0_save_path',       type=str,       default=f'log/minus_{3358}/version_{2}/ddpg0_final_model.pt')
    parser.add_argument('--agent1_save_path',       type=str,       default=f'log/minus_{3358}/version_{2}/ddpg1_final_model.pt')
