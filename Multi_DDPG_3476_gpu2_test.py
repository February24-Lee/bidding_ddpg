...
if __name__ == "__main__":
    ...
    # --- test 
    parser.add_argument('--agent0_save_path',       type=str,       default=f'log/minus_{3476}/version_{1}/ddpg0_final_model.pt')
    parser.add_argument('--agent1_save_path',       type=str,       default=f'log/minus_{3476}/version_{1}/ddpg1_final_model.pt')
