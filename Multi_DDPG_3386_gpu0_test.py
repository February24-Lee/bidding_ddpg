...
if __name__ == "__main__":
    ...
    # --- auction path
    parser.add_argument('--camp',                   type=str,       default='3386')
    ...
    # --- linear agent
    parser.add_argument('--lin-b0-path',            type=str,       default=f'data/linear_agent/ipinyou-data/{3386}/bid-model/lin-bid_1000_{1/32}_clk_{105523}.pickle')

    # --- test 
    parser.add_argument('--agent0_save_path',       type=str,       default=f'log/minus_{3386}/version_{1}/ddpg0_final_model.pt')
    parser.add_argument('--agent1_save_path',       type=str,       default=f'log/minus_{3386}/version_{1}/ddpg1_final_model.pt')
