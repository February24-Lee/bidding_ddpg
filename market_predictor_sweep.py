...
from src.marketModeling.util_funcs      import prepare_data, prepare_data_multi, plot_figures
import pprint as pp
...
def main(args):
    ...
    if args['train']:
        ...
        x, c, m1, m2 = prepare_data(x, market_price, sample_size, args['train'])
        ...
        valdata = logData(x_val, c_val, m1_val, m2_val)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--budget',         help='the proportion of the budget',    default=1/2)
    ...
    # Training parameters
    parser.add_argument('--sample-size',    help='training sample size [1e4, 1e6, all]',    default='all')
    ...
    parser.add_argument('--train',          help='train / test the model',      default=True,
                        type=lambda x: (str(x).lower() == 'true'))
