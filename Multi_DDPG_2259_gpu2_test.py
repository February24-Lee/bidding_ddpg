...
if __name__ == "__main__":
    ...
    # --- test 
    parser.add_argument('--agent0_save_path',       type=str,       default=f'log/minus_{2259}/version_{2}/ddpg0_final_model.pt')
    parser.add_argument('--agent1_save_path',       type=str,       default=f'log/minus_{2259}/version_{2}/ddpg1_final_model.pt')
